 ...
 * @param {Object} [options={}] - Additional request options (headers, data, etc.).
 * @param {number} [retries=3] - Maximum number of retries.
 * @returns {Promise<Response>} - Playwright API Response object.
 * @throws {Error} If request fails after all retries.
 */
RestUtils.prototype.requestWithRetry = async function (
  method,
  url,
  options = {},
  retries = 3
 ...
 * @returns {Promise<Array<Response>>} - Array of Playwright API Response objects.
