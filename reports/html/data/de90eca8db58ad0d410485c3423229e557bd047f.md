...
- Name: Salesforce Page Generator >> should generate a valid page class from elements
- Location: /Users/mzahirudeen/playwright-framework/tests/generators/sf-page-generator.test.js:14:3
...
Expected substring: "async fillFirstName(value)"
Received string:    "/**
 * TestPage - Page Object
...
class TestPage extends BasePage {
  ...
  constructor(page) {
    ...
    this.url = '/test/url';·····
    // Selectors
    this.firstNameInput = 'lightning-input[label=\"First Name\"]';
    this.lastNameInput = 'lightning-input[label=\"Last Name\"]';
    this.saveButton = '[name=\"SaveEdit\"]';
  }·
  /**
...
module.exports = TestPage;"
    at /Users/mzahirudeen/playwright-framework/tests/generators/sf-page-generator.test.js:47:23
```
...
```ts
   1 | /**
   2 |  * Tests for Salesforce Page Generator
   3 |  */
   4 | const { test, expect } = require('@playwright/test');
   5 | const { 
   6 |   generatePageClass, 
   7 |   findElementsByType,
   8 |   getElementName,
   9 |   formatName,
