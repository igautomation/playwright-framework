...
const cliPath = path.resolve(__dirname, '../src/cli/scrape.js');
...
try {
  ...
  const symlinkPath = path.join(binDir, 'scrape');
...
try {
  ...
  packageJson.bin.scrape = 'src/cli/scrape.js';
  ...
  console.log('   scrape [command] [options]');
} catch (error) {
