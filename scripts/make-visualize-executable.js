...
const cliPath = path.resolve(__dirname, '../src/cli/visualize.js');
...
try {
  ...
  const symlinkPath = path.join(binDir, 'visualize');
...
try {
  ...
  packageJson.bin.visualize = 'src/cli/visualize.js';
  ...
  console.log('   visualize [command] [options]');
} catch (error) {
