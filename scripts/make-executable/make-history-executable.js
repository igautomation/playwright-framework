...
const cliPath = path.resolve(__dirname, '../src/cli/history.js');
...
try {
  ...
  const symlinkPath = path.join(binDir, 'history');
...
try {
  ...
  packageJson.bin.history = 'src/cli/history.js';
  ...
  console.log('   history [command] [options]');
} catch (error) {
