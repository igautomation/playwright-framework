...
const resultsPath =
  process.env.PW_RESULTS_PATH || "playwright-report/results.json";
const mappingPath =
  process.env.TEST_MAPPING_PATH || "src/config/test-mapping.json";
  ...
  try {
    ...
    const payload = {
      info: {
        ...
        description:
          process.env.XRAY_DESCRIPTION ||
          "Framework auto-generated Xray payload",
