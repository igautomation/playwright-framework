...
// Add a simple PlaywrightErrorHandler
const PlaywrightErrorHandler = {
...
const baseUrl = process.env.BASE_URL || config.baseUrl || 'https://opensource-demo.orangehrmlive.com';
const apiBaseUrl = process.env.API_BASE_URL || config.api?.baseUrl || 'https://opensource-demo.orangehrmlive.com/api';
...
const username = process.env.USERNAME || config.credentials?.username || 'Admin';
const password = process.env.PASSWORD || config.credentials?.password || 'admin123';

// Use direct selector values
const selectors = {
  usernameInput: 'input[name="username"]',
  passwordInput: 'input[name="password"]',
  loginButton: 'button[type="submit"]',
  pimLink: 'a:has-text("PIM")',
