...
const ContactPage = require('../../pages/salesforce/ContactPage_bk');
...
test('Create a new contact under Postman account', async ({ page }) => {
  ...
  try {
    ...
    await loginPage.login(
      process.env.SALESFORCE_USERNAME || process.env.SF_USERNAME,
      process.env.SALESFORCE_PASSWORD || process.env.SF_PASSWORD
    );
