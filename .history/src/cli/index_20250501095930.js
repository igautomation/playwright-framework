...
function loadEnvironmentVariables(projectDir) {
  ...
  try {
    // Load typed env file and validate against .env.example
    loadEnv({
...
(async () => {
  try {
    yargs(hideBin(process.argv))
      ...
      // List all test @tags from .spec.js files
      ...
      // Push test execution results to Xray
