...
class LoginPage extends BasePage {
  ...
  async navigate() {
    try {
      ...
      if (error.message.includes('waiting for selector') || error.message.includes('frame was detached')) {
        try {
          ...
          throw new Error(`Failed to navigate to login page: ${error.message}. Additional error: ${fallbackError.message}`);
        }
      }
