  ...
  [341],
  {
    1021: (e, t, n) => {
      ...
      function r(e) {
        ...
        return t.flatMap((e) => {
          const t = r({ toc: e.children, minHeadingLevel: n, maxHeadingLevel: s });
          return (function (e) {
        ...
        (0, s.useEffect)(() => {
          ...
          function c() {
            const e = (function (e) {
              ...
              l = i(c, { anchorTopOffset: n.current }),
              d = e.find(
                (e) =>
                  l &&
                  l.id ===
      ...
      function p(e) {
        ...
        return (
          ...
          (0, m.jsx)(f, { toc: j, className: n, linkClassName: c, ...h })
        );
      }
    },
    1708: (e, t, n) => {
      ...
      function d(e) {
        ...
        return (0, i.jsxs)(r.A, {
          to: t,
          className: o.G.common.editThisPage,
          children: [
            (0, i.jsx)(l, {}),
            (0, i.jsx)(a.A, {
      ...
      function h(e) {
        ...
        const n = new Date(t),
          s = m({ day: 'numeric', month: 'short', year: 'numeric', timeZone: 'UTC' }).format(n);
        return (0, i.jsx)(a.A, {
        ...
        return (0, i.jsxs)('span', {
          ...
          children: [
            (0, i.jsx)(a.A, {
              ...
              values: {
                atDate: t ? (0, i.jsx)(h, { lastUpdatedAt: t }) : '',
                byUser: n ? (0, i.jsx)(f, { lastUpdatedBy: n }) : ''
              },
      ...
      const x = { lastUpdated: 'lastUpdated_JAkA' };
      function g(e) {
        let { className: t, editUrl: n, lastUpdatedAt: a, lastUpdatedBy: o } = e;
        return (0, i.jsxs)('div', {
          className: (0, s.A)('row', t),
          children: [
            (0, i.jsx)('div', { className: 'col', children: n && (0, i.jsx)(d, { editUrl: n }) }),
            (0, i.jsx)('div', {
              className: (0, s.A)('col', x.lastUpdated),
              children: (a || o) && (0, i.jsx)(p, { lastUpdatedAt: a, lastUpdatedBy: o })
            })
          ]
        });
      }
    ...
    2362: (e, t, n) => {
      ...
      function o(e) {
        const { mdxAdmonitionTitle: t, rest: n } = (function (e) {
            ...
            return {
              ...
              rest: o.length > 0 ? (0, a.jsx)(a.Fragment, { children: o }) : null
            };
          })(e.children),
          o = e.title ?? t;
      ...
      function h(e) {
        ...
        return (0, a.jsx)('div', {
          className: (0, r.A)(i.G.common.admonition, i.G.common.admonitionType(t), l, n),
          children: s
        });
      }
      function f(e) {
        ...
        return (0, a.jsxs)('div', {
          className: d,
          children: [(0, a.jsx)('span', { className: u, children: t }), n]
        });
      }
      function p(e) {
        let { children: t } = e;
        return t ? (0, a.jsx)('div', { className: m, children: t }) : null;
      }
      function x(e) {
        const { type: t, icon: n, title: s, children: o, className: r } = e;
        return (0, a.jsxs)(h, {
          type: t,
          className: r,
          children: [
      ...
      const _ = {
        ...
        ...{
          secondary: (e) => (0, a.jsx)(b, { title: 'secondary', ...e }),
    ...
    4522: (e, t, n) => {
      ...
      const N = 'codeBlockContainer_Ckt0';
      var y = n(4848);
      function A(e) {
        let { as: t, ...n } = e;
        const s = (function (e) {
        ...
        return (0, y.jsx)(t, {
          ...n,
          style: s,
          className: (0, c.A)(n.className, N, u.G.common.codeBlock)
        });
      }
      const k = {
      ...
      function C(e) {
        ...
        return (0, y.jsx)(A, {
          as: 'pre',
          tabIndex: 0,
          className: (0, c.A)(k.codeBlockStandalone, 'thin-scrollbar', n),
          children: (0, y.jsx)('code', { className: k.codeBlockLines, children: t })
        });
      }
      var B = n(6849);
        ...
        return (0, y.jsxs)('span', {
          ...
          children: [
            s
              ? (0, y.jsxs)(y.Fragment, {
                  children: [
                    (0, y.jsx)('span', { className: _ }),
                    (0, y.jsx)('span', { className: H, children: i })
                  ]
                })
              : i,
            (0, y.jsx)('br', {})
      ...
      function R(e) {
        ...
        const [a, o] = (0, s.useState)(!1),
          ...
          i = (0, s.useCallback)(() => {
            !(function (e, t) {
              ...
              s.remove(), r && (o.removeAllRanges(), o.addRange(r)), a && a.focus();
            })(t),
              o(!0),
        ...
        return (
          ...
          (0, y.jsx)('button', {
            ...
            className: (0, c.A)('clean-btn', n, z.copyButton, a && z.copyButtonCopied),
            onClick: i,
            children: (0, y.jsxs)('span', {
              className: z.copyButtonIcons,
              'aria-hidden': 'true',
              children: [
                (0, y.jsx)(U, { className: z.copyButtonIcon }),
                (0, y.jsx)(I, { className: z.copyButtonSuccessIcon })
              ]
            })
          })
        );
      ...
      const O = 'wordWrapButtonIcon_Bwma',
      ...
      function D(e) {
        ...
        return (0, y.jsx)('button', {
          type: 'button',
          onClick: n,
          className: (0, c.A)('clean-btn', t, s && $),
          'aria-label': a,
          title: a,
          children: (0, y.jsx)(V, { className: O, 'aria-hidden': 'true' })
        });
      }
      function P(e) {
        let {
        ...
        const {
          ...
          { lineClassNames: j, code: b } = v(t, { metastring: a, language: h, magicComments: m }),
          N =
            r ??
            (function (e) {
        ...
        return (0, y.jsxs)(A, {
          as: 'div',
          className: (0, c.A)(n, h && !n.includes(`language-${h}`) && `language-${h}`),
          children: [
            g && (0, y.jsx)('div', { className: k.codeBlockTitle, children: g }),
            (0, y.jsxs)('div', {
              ...
              children: [
                (0, y.jsx)(E.f4, {
                  ...
                  children: (e) => {
                    ...
                    return (0, y.jsx)('pre', {
                      tabIndex: 0,
                      ref: x.codeBlockRef,
                      className: (0, c.A)(t, k.codeBlock, 'thin-scrollbar'),
                      style: n,
                      children: (0, y.jsx)('code', {
                        className: (0, c.A)(k.codeBlockLines, N && k.codeBlockLinesWithNumbering),
                        children: s.map((e, t) =>
                          (0, y.jsx)(
                            S,
                            {
                ...
                (0, y.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, y.jsx)(R, { className: k.codeButton, code: b })
                  ]
                })
              ]
            })
      ...
      function q(e) {
        ...
        const a = (0, r.A)(),
          ...
          c = 'string' == typeof o ? P : C;
        return (0, y.jsx)(c, { ...n, children: o }, String(a));
      }
      function G(e) {
        return (0, y.jsx)('code', { ...e });
      }
      var W = n(6289);
      var F = n(5246),
        Z = n(3535);
      ...
      function ee(e) {
        ...
        (0, F.A)().collectAnchor(a.id);
        const o = (0, r.A)(),
          i = (0, s.useRef)(null),
          { collapsed: l, setCollapsed: d } = (0, Z.u)({ initialState: !a.open }),
          [u, m] = (0, s.useState)(a.open),
          h = s.isValidElement(t) ? t : (0, y.jsx)('summary', { children: t ?? 'Details' });
        return (0, y.jsxs)('details', {
          ...a,
          ref: i,
          open: u,
          'data-collapsed': l,
          className: (0, c.A)(J, o && Y, a.className),
          onMouseDown: (e) => {
          ...
          children: [
            ...
            (0, y.jsx)(Z.N, {
              ...
              children: (0, y.jsx)('div', { className: K, children: n })
            })
          ]
        });
      }
      ...
      function ne(e) {
        let { ...t } = e;
        return (0, y.jsx)(ee, { ...t, className: (0, c.A)('alert alert--info', te, t.className) });
      }
      function se(e) {
        const t = s.Children.toArray(e.children),
          n = t.find((e) => s.isValidElement(e) && 'summary' === e.type),
          a = (0, y.jsx)(y.Fragment, { children: t.filter((e) => e !== n) });
        return (0, y.jsx)(ne, { ...e, summary: n, children: a });
      }
      var ae = n(9303);
      function oe(e) {
        return (0, y.jsx)(ae.A, { ...e });
      }
      const re = 'containsTaskList_mC6p';
      function ce(e) {
        if (void 0 !== e) return (0, c.A)(e, e?.includes('contains-task-list') && re);
      }
      const ie = 'img_ev3q';
      var le = n(2362),
        de = n(205);
      const ue = {
        ...
        a: function (e) {
          return (0, y.jsx)(W.A, { ...e });
        },
        pre: function (e) {
          return (0, y.jsx)(y.Fragment, { children: e.children });
        },
        ul: function (e) {
          return (0, y.jsx)('ul', { ...e, className: ce(e.className) });
        },
        li: function (e) {
          return (0, F.A)().collectAnchor(e.id), (0, y.jsx)('li', { ...e });
        },
        img: function (e) {
          return (0, y.jsx)('img', {
            decoding: 'async',
            loading: 'lazy',
            ...e,
            className: ((t = e.className), (0, c.A)(t, ie))
          });
          var t;
        },
        h1: (e) => (0, y.jsx)(oe, { as: 'h1', ...e }),
        h2: (e) => (0, y.jsx)(oe, { as: 'h2', ...e }),
        h3: (e) => (0, y.jsx)(oe, { as: 'h3', ...e }),
        h4: (e) => (0, y.jsx)(oe, { as: 'h4', ...e }),
        h5: (e) => (0, y.jsx)(oe, { as: 'h5', ...e }),
        h6: (e) => (0, y.jsx)(oe, { as: 'h6', ...e }),
        admonition: le.A,
        mermaid: de.A
      };
      function me(e) {
        let { children: t } = e;
        return (0, y.jsx)(a.x, { components: ue, children: t });
      }
    },
    7959: (e, t, n) => {
      'use strict';
      ...
      function l(e) {
        let { className: t, ...n } = e;
        return (0, r.jsx)('div', {
          className: (0, s.A)(o.tableOfContents, 'thin-scrollbar', t),
          children: (0, r.jsx)(a.A, { ...n, linkClassName: c, linkActiveClassName: i })
        });
      }
    },
    8426: (e, t) => {
    ...
    8467: (e, t, n) => {
      ...
      function f(e) {
        ...
        return (0, r.jsx)(h.A, {
          type: 'caution',
          title: (0, r.jsx)(d, {}),
          className: (0, s.A)(t, m.G.common.draftBanner),
          children: (0, r.jsx)(u, {})
        });
      }
      function p(e) {
        ...
        return (0, r.jsx)(h.A, {
          type: 'caution',
          title: (0, r.jsx)(c, {}),
          className: (0, s.A)(t, m.G.common.unlistedBanner),
          children: (0, r.jsx)(i, {})
        });
      }
      function x(e) {
        return (0, r.jsxs)(r.Fragment, { children: [(0, r.jsx)(l, {}), (0, r.jsx)(p, { ...e })] });
      }
      function g(e) {
        let { metadata: t } = e;
        const { unlisted: n, frontMatter: s } = t;
        return (0, r.jsxs)(r.Fragment, {
          children: [(n || s.unlisted) && (0, r.jsx)(x, {}), s.draft && (0, r.jsx)(f, {})]
        });
      }
    }
  }
