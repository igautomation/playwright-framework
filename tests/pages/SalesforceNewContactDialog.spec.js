...
test.describe('SalesforceNewContactDialog Tests', () => {
  ...
  test('should interact with form elements', async () => {
    ...
    // Fill Select 32 items field
    await salesforceNewContactDialog.fillSelect_32_items('Test value');
    // Fill Select 32 items Column Width field
    await salesforceNewContactDialog.fillSelect_32_items_column_width('Test value');
